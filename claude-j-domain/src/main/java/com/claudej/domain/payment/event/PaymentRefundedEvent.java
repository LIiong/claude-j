...
/**
 * Payment refunded domain event - triggered when payment is refunded
 */
@Getter
public class PaymentRefundedEvent extends DomainEvent {
    ...
    public PaymentRefundedEvent(String eventId, LocalDateTime occurredOn, String paymentId,
     ...
     */
    public static PaymentRefundedEvent create(String paymentId, String orderId, String customerId,
