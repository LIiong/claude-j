...
| # | 任务 | 负责人 | 状态 | 备注 |
|---|------|--------|------|------|
| 1 | Domain: PageRequest + SortDirection 值对象 + 测试 | dev | 待办 | 分页请求参数 |
| 2 | Domain: Page<T> 值对象 + 测试 | dev | 待办 | 分页结果 |
| 3 | Domain: Repository 接口新增分页方法 | dev | 待办 | 4 个 Repository |
| 4 | Application: PageDTO + PageAssembler | dev | 待办 | 分页 DTO 与转换器 |
| 5 | Application: ApplicationService 新增分页方法 + 测试 | dev | 待办 | 5 个 Service |
| 6 | Infrastructure: PageHelper 工具类 | dev | 待办 | MyBatis-Plus Page 转换 |
| 7 | Infrastructure: RepositoryImpl 分页方法实现 + 测试 | dev | 待办 | 4 个 RepositoryImpl |
| 8 | Adapter: PageResponse + PageRequestAdapter | dev | 待办 | 分页响应与请求参数 |
| 9 | Adapter: Controller 分页改造 + 测试 | dev | 待办 | 5 个 Controller |
| 10 | 全量 mvn test | dev | 待办 | 含 ArchUnit |
| 11 | QA: 测试用例设计 | qa | 待办 | |
